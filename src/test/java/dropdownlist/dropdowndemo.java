...
public class dropdowndemo {
	...
	public static void main(String[] args) {
		...
		// TODO Auto-generated method stub
		 ...
		 WebElement maleRadio=driver.findElement(By.xpath("//input[@id=\"sex\" and @value=\"1\"]"));
		 
		 maleRadio.click();
		 
		 WebElement registermailid=driver.findElement(By.xpath("//input[@name=\"reg_email__\"]"));
		 
		 registermailid.sendKeys("deepak.podile@gmail.com");
		 
		WebElement Passwoard=driver.findElement(By.xpath("//input[@type=\"password\"]"));
