...
public class TestCase8 {
	...
	public static void main(String[] args) {
		...
		String destinationFilePath = System.getProperty("user.dir")
				+ File.separator + "TestCase8/" + fileName;
		...
		WebElement products=driver.findElement(By.xpath("//header[@id=\"header\"]/div/div/div/div[2]/div/ul/li[2]/a"));
		...
		String destinationFilePath2 = System.getProperty("user.dir")
				+ File.separator + "TestCase8/" + fileName2;
		...
		String destinationFilePath3 = System.getProperty("user.dir")
				+ File.separator + "TestCase8/" + fileName3;

		System.out.println(destinationFilePath3);
